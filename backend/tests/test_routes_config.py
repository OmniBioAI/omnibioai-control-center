...
# config_router is gated at router-inclusion time (main.py) behind
# platform.manage_infra -- these tests exercise the route's own logic, not
# authorization (see test_main.py for the 401/403 permission checks), so
# the client carries a fixed, always-sufficient token by default.
